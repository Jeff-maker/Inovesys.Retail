...
namespace Inovesys.Retail.Models
{
    public class NFeXml
    {
        ...
        public NFeXml(Invoice invoice, string environmentSefaz, LiteDbService liteDbService, Branche branche, Company company, X509Certificate2 x509Certificate2)
        {
            _invoice = invoice;
        ...
        public (XmlDocument Xml, string QrCode, string dateHoraEmissao, Exception Error) Build()
        {
            try
            {
                ...
                GenerateNFeSignatureAndQrCode(ref xmlSemmIdentacao, _environmentSefaz, dateHoraEmissao, out string QrCode);
        ...
        private void GenerateNFeSignatureAndQrCode(ref XmlDocument xmlDoc, string sefazEnviroment, string dataHoraEmissao, out string qrCodeValue)
        {
            try
            {

...
{
    public class CofinsDetermination99
    {
        [BsonId]
        public string CompositeKey => $"{ClientId}-{CountryId}-{InvoiceTypeId}-{StartDate:yyyyMMdd}";
        ...
        [BsonIgnore]
        public string Display => $"{InvoiceTypeId} | {StartDate:yyyy-MM-dd} | CST {CstId} | {Rate:P}";
    }
}
